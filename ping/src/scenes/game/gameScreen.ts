...
class GameScreen extends Screen{
    ...
    constructor(gameData){
        super(gameData);
        this.ball = new Ball(gameData.canvas.clientWidth/2 + 5,gameData.canvas.height/2 + 5, 1.5);
        this.player = new Paddle(gameData.canvas.clientWidth/2 - 30, gameData.canvas.height - 30, 60, 10);
        this.enemy = new Paddle(gameData.canvas.clientWidth/2 - 30, 20, 60, 10);
    }
    update(deltaTime, updateStore, playEffect): void{
        this.ball.move();
    ...
    checkPaddleCollission(paddle: Paddle){
    ...
    checkForPointMatch(score: number): boolean{
